  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-300 font-sans selection:bg-zinc-800">
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 lg:py-32">
        <div className="flex flex-col items-center text-center mb-24">
          ...
          <p className="text-lg md:text-xl text-zinc-400 mb-10 max-w-2xl leading-relaxed">
            A professional invoice generator secured by your fingerprint or
            face. Your financial data is saved directly on your device. No
            sign-ups, no subscriptions, zero servers.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-2xl flex flex-col items-center text-center shrink-0">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-4">
                Secured by FaceID / TouchID. Your device hardware provides the
                master key to unlock your financial data.
              </p>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-2xl flex flex-col items-center text-center shrink-0">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-4">
                Data is saved directly to your machine. High-performance local
                database ensures your info never leaves your device.
              </p>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-2xl flex flex-col items-center text-center shrink-0">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-4">
                Everything executes locally. Operations happen in
      ...
      <footer className="border-t border-zinc-800 py-8 text-center text-sm text-zinc-500 px-6">
        ...
        <p>
          © {new Date().getFullYear()} Sovereignty Apps. Built for Sovereignty.
        </p>
      </footer>
    </div>
  );
